...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Using send method instead of sendForm for more direct control
        emailjs
    ...
    return (
        <section id="contact" className="min-h-screen flex items-center justify-center py-12 md:py-20"
        >
            <RevealOnScroll>
